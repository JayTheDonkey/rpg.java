...
public static void main(String[] args) {
  ...
  Player human = new Player("Rogue", "Joe", new MeleeWeapon[]{MakeMeleeWeapon.rapier("sneaky")}, new RangedWeapon[]{MakeRangedWeapon.crossbow("normal")}, new Spell[]{MakeSpell.frostBurn("annoying")}, 15, 13, 18, 12, 14, 8, 10, 7, 20, 0, 500);
