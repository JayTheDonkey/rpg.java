public class MakeMonster {
  public static Monster skeleton() {
    return new Monster("Skeleton", new MeleeWeapon[]{MakeMeleeWeapon.shortSword("rusty")}, new RangedWeapon[]{MakeRangedWeapon.rock("boring")}, 20, 6, 4, 0, 15);
   }
 ...
 public static Monster flameArcher() {
   return new Monster("Flame Archer", new MeleeWeapon[]{MakeMeleeWeapon.baton("flaming")}, new RangedWeapon[]{MakeRangedWeapon.enchantedBow("flaming")}, 12, 6, 4, 0, 20);
  }
